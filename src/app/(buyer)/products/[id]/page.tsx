          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <p className="font-medium text-gray-700">
                4.5 <span className="text-sm text-gray-500">(600 đánh giá)</span>
              </p>
            </div>
            <div className="flex flex-row">
...
const Review = ({ name, date, rating, comment }: ReviewData) => {
  return (
...
export function ReviewSection() {
  ...
  const filtered = useMemo(() => {
    ...
    return list;
  }, [filterRating, sortOrder, reviews]); // Added reviews to dependency array
